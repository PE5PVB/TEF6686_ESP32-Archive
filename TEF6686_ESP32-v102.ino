...
bool menu;
bool menuopen = false;
bool RDSstatusold = true;
bool SQ;
bool Stereostatusold = true;
...
void BuildMenu() {
    ...
    tft.drawLine(0,27,320,27,TFT_BLUE);
    tft.setTextColor(TFT_SKYBLUE);
    tft.drawCentreString("PRESS MODE TO EXIT AND STORE", 150, 222, 2);
    tft.drawCentreString("MENU",160,4,4);
    tft.drawRoundRect(10,menuoption,300,18,5,TFT_WHITE);
    tft.setTextColor(TFT_WHITE);
    ...
    tft.drawRightString(VERSION, 310, 222, 2);
