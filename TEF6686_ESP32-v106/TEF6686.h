...
class TEF6686 {
  public:
    ...
    uint8_t getBootStatus(int16_t &bootstatus);
    uint16_t seekDown(uint16_t LowEdge, uint16_t HighEdge, int16_t threshold);
    uint16_t seekSync(uint8_t up, uint16_t LowEdge, uint16_t HighEdge, int16_t threshold);
    uint16_t seekUp(uint16_t LowEdge, uint16_t HighEdge, int16_t threshold);
  ...
  private:
    ...
    char unsafePs[2][8];
    uint16_t seek(uint8_t up, uint16_t LowEdge, uint16_t HighEdge, int16_t threshold);
    uint16_t seekMode;
