...
uint16_t TEF6686::seekUp(uint16_t LowEdge, uint16_t HighEdge, int16_t threshold) {
...
uint16_t TEF6686::seekDown(uint16_t LowEdge, uint16_t HighEdge, int16_t threshold) {
...
uint16_t TEF6686::seek(uint8_t up, uint16_t LowEdge, uint16_t HighEdge, int16_t threshold) {
  uint16_t mode = 20;
...
uint16_t TEF6686::seekSync(uint8_t up, uint16_t LowEdge, uint16_t HighEdge, int16_t threshold) {
  if (seekMode == 0) {  
    seekMode = 20;
