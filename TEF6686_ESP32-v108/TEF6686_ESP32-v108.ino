...
{
  if (SStatus > (SStatusold +4) || SStatus < (SStatusold -4))
  {
    String count = String(SStatus/10, DEC);
...
void doSquelch() {
  ...
  if (USBstatus == false) {
    ...
    if (menu == false && Squelch != Squelchold) {
      if (screenmute == false) {
        ...
        if (Squelchold == -100) {
          tft.print("OFF");
        } else if (Squelchold == -1 || Squelchold > 920) {
          tft.print("STEREO");
        } else {
        ...
        if (Squelch == -100) {
          tft.print("OFF");
        } else if ((Squelch == -1 && (USBstatus == true)) || Squelch > 920) {
          tft.print("STEREO");
        } else {
  ...
  if (screenmute == false) {ShowSquelch();}
}
